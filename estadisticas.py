...
## Modo normal
geografia = ['Geography']
entretenimiento = ['Film', 'Music', 'Musicals & Theatres', 'Television', 'Video Games', 'Board Games', 'Celebrities', 'Comics', 'Anime & Manga', 'Cartoon & Animations']
historia = ['History', 'Mythology']
